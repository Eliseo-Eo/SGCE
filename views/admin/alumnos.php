                                    ...
                                    <tr data-etapa="<?= htmlspecialchars((string)($Al['Grado'] ?? $Al['EtapaOrden'] ?? ''), ENT_QUOTES, 'UTF-8') ?>" data-grupo="<?= htmlspecialchars(SgceNormalizarMayusculas((string)($Al['Grupo'] ?? '')), ENT_QUOTES, 'UTF-8') ?>" data-turno="<?= htmlspecialchars(SgceNormalizarMayusculas((string)($Al['Turno'] ?? '')), ENT_QUOTES, 'UTF-8') ?>">
                                        ...
                                        <td class="text-center">
                                            <div class="AdminActions AlumnosActions">
                                                ...
                                                <form method="POST" class="m-0 p-0" data-sgce-confirm="delete" data-sgce-confirm-title="DAR DE BAJA ALUMNO" data-sgce-confirm-subtitle="BAJA ADMINISTRATIVA" data-sgce-confirm-message="¿DESEAS DAR DE BAJA A ESTE ALUMNO? ESTA ACCIÓN NO SE PUEDE DESHACER." data-sgce-confirm-detail="El alumno será dado de baja administrativamente. Revisa que sea el registro correcto antes de continuar." data-sgce-confirm-button="SÍ, DAR DE BAJA" data-sgce-confirm-loading="DANDO DE BAJA..." data-sgce-confirm-icon="fa-user-slash">
                    <?php echo CampoCsrf(); ?>
                                                    <input type="hidden" name="Tab" value="alumnos">
