...
/* ==========================================================
   FIX8 - REPORTES: BOTONES PRINCIPALES RELLENOS TINTO
   Estos estilos ganan sobre cualquier regla anterior.
   ========================================================== */
body .ReporteBtn,
body button.ReporteBtn,
body .btn.ReporteBtn,
body .Btn.ReporteBtn,
body form .ReporteBtn,
body .card .ReporteBtn,
body .Card .ReporteBtn,
body .card button.btn.Btn.ReporteBtn,
body .Card button.btn.Btn.ReporteBtn{
    background:linear-gradient(135deg,#7A0818,#A10D26) !important;
    color:#FFFFFF !important;
    ...
    box-shadow:0 10px 24px rgba(122,8,24,.22) !important;
    text-decoration:none !important;
}
body .ReporteBtn i,
body button.ReporteBtn i,
body .btn.ReporteBtn i,
body .Btn.ReporteBtn i{
    color:#FFFFFF !important;
}
...
body .Btn.ReporteBtn:hover,
body form .ReporteBtn:hover,
body .card .ReporteBtn:hover,
body .Card .ReporteBtn:hover,
body .card button.btn.Btn.ReporteBtn:hover,
body .Card button.btn.Btn.ReporteBtn:hover{
    background:linear-gradient(135deg,#4F050F,#7A0818) !important;
    color:#FFFFFF !important;
    border-color:#4F050F !important;
    transform:translateY(-2px) !important;
    box-shadow:0 14px 30px rgba(122,8,24,.32) !important;
}
body .ReporteBtn:hover i,
body button.ReporteBtn:hover i,
body .btn.ReporteBtn:hover i,
body .Btn.ReporteBtn:hover i{
    color:#FFFFFF !important;
}
