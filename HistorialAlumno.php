...
/* ==========================================================
   FIX29 - Botón BOLETA PDF en verde metálico profesional
   Borde tinto fuerte homologado con VOLVER A INICIO.
========================================================== */
html body .Top .BtnBoletaPdf,
html body a.BtnBoletaPdf,
html body .BtnBack.BtnBoletaPdf{
    background:
        linear-gradient(145deg,rgba(255,255,255,.28) 0%,rgba(255,255,255,.06) 18%,transparent 35%),
        linear-gradient(135deg,#0B7A4B 0%,#065F46 45%,#043B2E 100%) !important;
    background-image:
        linear-gradient(145deg,rgba(255,255,255,.28) 0%,rgba(255,255,255,.06) 18%,transparent 35%),
        linear-gradient(135deg,#0B7A4B 0%,#065F46 45%,#043B2E 100%) !important;
    color:#FFFFFF !important;
...
html body .Top .BtnBoletaPdf i,
html body a.BtnBoletaPdf i,
html body .BtnBack.BtnBoletaPdf i{
    color:#FFFFFF !important;
    filter:drop-shadow(0 1px 1px rgba(0,0,0,.25)) !important;
}
html body .Top .BtnBoletaPdf:hover,
html body a.BtnBoletaPdf:hover,
html body .BtnBack.BtnBoletaPdf:hover{
    background:
        linear-gradient(145deg,rgba(255,255,255,.34) 0%,rgba(255,255,255,.08) 20%,transparent 38%),
        linear-gradient(135deg,#0E8F5A 0%,#047857 45%,#064E3B 100%) !important;
    background-image:
        linear-gradient(145deg,rgba(255,255,255,.34) 0%,rgba(255,255,255,.08) 20%,transparent 38%),
        linear-gradient(135deg,#0E8F5A 0%,#047857 45%,#064E3B 100%) !important;
    color:#FFFFFF !important;
    border-color:#5E0612 !important;
    transform:translateY(-2px) scale(1.015) !important;
    box-shadow:
        0 16px 34px rgba(0,0,0,.32),
        0 0 0 4px rgba(122,8,24,.22),
        0 0 18px rgba(16,185,129,.32),
        inset 0 1px 0 rgba(255,255,255,.52),
        inset 0 -8px 16px rgba(0,0,0,.18) !important;
    filter:saturate(1.12) contrast(1.03) !important;
}
html body .Top .BtnBoletaPdf:hover i,
html body a.BtnBoletaPdf:hover i,
html body .BtnBack.BtnBoletaPdf:hover i{
    color:#FFFFFF !important;
}
@media (max-width:768px){
    html body .Top .BtnBoletaPdf,
